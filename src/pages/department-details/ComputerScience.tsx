...
import { Star, Cpu, ArrowLeft, Mail, Phone, Award, User, ChevronLeft, ChevronRight } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="mb-8">
              <h2 className="text-3xl font-bold text-foreground mb-4">Computer Science Engineering</h2>
              ...
              <div className="relative mb-8">
                <img 
                  src="/images/departments/Computer Science Engineering.jpg" 
              ...
              <Tabs defaultValue="description" className="w-full">
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed">
                        The Computer Engineering Department was started in the year 1995-1996, with the intake 60 students. 40 Systems in the multimedia lab, and for programming lab, 20 systems for Hardware & Networking lab students are participated in intercollegiate seminars & quiz competitions conducted by various colleges and won many prizes. They also have won many prizes in extra curricular activities. Every semester one day workshop is conducted for Installation & servicing and Network & Administration subjects.
                      </p>
                    </div>
                ...
                <TabsContent value="staff" className="mt-6">
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-muted-foreground mb-6">
                        Our experienced faculty members provide comprehensive training in computer science and engineering.
                      </p>
                    </div>
                    
                    <div className="grid md:grid-cols-2 gap-6">
                      {staffData["computer-technology"].map((staff, index) => (
                ...
                <TabsContent value="facilities" className="mt-6">
                  <div className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <Card className="p-4">
                        <h4 className="font-semibold mb-2">Programming Lab</h4>
                        <p className="text-sm text-muted-foreground">20 systems for programming practice</p>
                      </Card>
                      <Card className="p-4">
                        <h4 className="font-semibold mb-2">Multimedia Lab</h4>
                        <p className="text-sm text-muted-foreground">40 systems for multimedia projects</p>
                      </Card>
                      <Card className="p-4">
                        <h4 className="font-semibold mb-2">Hardware & Networking Lab</h4>
                        <p className="text-sm text-muted-foreground">Dedicated hardware and networking equipment</p>
                      </Card>
                      <Card className="p-4">
                        <h4 className="font-semibold mb-2">Software Lab</h4>
                        <p className="text-sm text-muted-foreground">Latest software development tools</p>
                      </Card>
                    </div>
                  </div>
                </TabsContent>
